                    ...
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="p-4 md:p-5">
                            <form className="space-y-4" action="#">
                                ...
                                <button type="buttom" className="inline-flex w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm gap-20 px-5 py-2.5 text-center">
                                    <img src="https://webimages.mongodb.com/_com_assets/cms/kr6fvgdym4qzsgqo3-Google%20Icon.svg?auto=format%252Ccompress" className="w-5 h-5" alt="google_logo"/>Sign in with Google</button>
