...
export function CallToAction() {
  return (
    <div className="object-contain inset-0 flex flex-col md:items-start justify-center items-center space-y-5 md:space-y-10 relative md:h-5/6 h-full  w-full pt-40 pb-10"
      ...
      and <span className="text-transparent bg-clip-text bg-gradient-to-l to-emerald-600 from-sky-400">Share</span> <br />Your <span className="text-transparent bg-clip-text bg-gradient-to-l to-emerald-600 from-sky-400">Adventures</span>
      </h2>
      ...
      <a to="/cities" >
        <button type="button" className=" flex text-white font-bold text-2xl  bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-large rounded-lg px-3 py-4 pb-3text-center ml-5 mb-2 gap-2"> Visit Cities
