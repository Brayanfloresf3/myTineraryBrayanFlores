...
export function CallToAction() {
    return (
        <div className="inset-0 flex flex-col md:items-start justify-center items-center space-y-5 sm:space-y-8  md:space-y-10 relative md:h-5/6 h-full md:pt-40 pt-20 pb-10 md:pl-7"
            ...
            <NavLink to="/signin" className="z-10 text-sm sm:text-sm md:text-sm lg:text-lg font-semibold text-gray-300 z-10 md:ml-5 text-sm sm:text-sm md:text-sm lg:text-lg font-semibold text-gray-300 z-10 md:ml-5">
                <div className='flex'>
