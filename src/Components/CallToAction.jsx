...
export function CallToAction() {
  return (
    <div className="object-contain inset-0 flex flex-col md:items-start justify-center items-center space-y-5 md:space-y-10 relative md:h-5/6 h-full  w-full pt-40 pb-10"
      ...
      <a to="/cities" >
        <button type="button" class=" flex text-white font-bold text-2xl  bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-large rounded-lg px-3 py-4 pb-3text-center ml-5 mb-2 gap-2"> Visit Cities
